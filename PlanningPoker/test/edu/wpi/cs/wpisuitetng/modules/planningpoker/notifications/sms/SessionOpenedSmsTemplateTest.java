 ...
 * @version Apr 28, 2014
 */
public class SessionOpenedSmsTemplateTest {
    private SessionOpenedSmsTemplate SOST;
    private User user;
    ...
    public void setUp(){
        ...
        SOST = new SessionOpenedSmsTemplate(session);
        user = new User("Tester Test", "test", "test", 123);
    }
    
    @Test
    public void TestShouldReceiveNotifications(){
        assertFalse(SOST.shouldReceiveNotifications(user));
    }
    
    @Test
    public void TestGenerateMessage(){
        SOST.generateMessage(user);
    }
}
