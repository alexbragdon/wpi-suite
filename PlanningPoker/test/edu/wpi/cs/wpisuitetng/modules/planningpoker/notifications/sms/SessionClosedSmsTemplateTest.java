 ...
 * @version Apr 28, 2014
 */
public class SessionClosedSmsTemplateTest {
    private SessionClosedSmsTemplate SCST;
    private User user;
    ...
    public void setUp(){
        ...
        SCST = new SessionClosedSmsTemplate(session);
        user = new User("Tester Test", "test", "test", 123);
    }
    
    @Test
    public void TestShouldReceiveNotifications(){
        assertFalse(SCST.shouldReceiveNotifications(user));
    }
    
    @Test
    public void TestGenerateMessage(){
        SCST.generateMessage(user);
    }
}
