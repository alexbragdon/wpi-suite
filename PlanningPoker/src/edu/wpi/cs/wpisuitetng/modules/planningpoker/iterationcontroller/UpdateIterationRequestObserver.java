 ...
 ******************************************************************************/
package edu.wpi.cs.wpisuitetng.modules.planningpoker.iterationcontroller;
 ...
 * to the server to add a Iteration.
 *
...
public class UpdateIterationRequestObserver implements RequestObserver {
	...
	private final UpdateIterationController controller;
	
	/**
	 * Constructs the observer given an AddIterationController
	 * @param controller the controller used to add Iterations
	 */
	public UpdateIterationRequestObserver(UpdateIterationController controller) {
	...
	public void responseError(IRequest iReq) {
		...
		System.err.println("The request to update a Iteration failed.");
	}
