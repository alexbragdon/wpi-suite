...
public class PostBoardMessage extends AbstractModel {
     ...
     * @param message
     */
    public PostBoardMessage(final String message) {
    ...
    /**
     * Returns an instance of PostBoardMessage constructed using the given PostBoardMessage encoded
     * as a JSON string.
     * 
     * @param json the json-encoded PostBoardMessage to deserialize
     * @return the PostBoardMessage contained in the given JSON
     */
    public static PostBoardMessage fromJSON(final String json) {
        final Gson parser = new Gson();
        return parser.fromJson(json, PostBoardMessage.class);
    }

    /**
     * Returns an array of PostBoardMessage parsed from the given JSON-encoded string.
     * 
     ...
     */
    public static PostBoardMessage[] fromJsonArray(final String json) {
        final Gson parser = new Gson();
        return parser.fromJson(json, PostBoardMessage[].class);
    }
    ...
    public String toString() {
        ...
        final DateFormat dateFormat = new SimpleDateFormat("MM/dd/yy hh:mm a");
