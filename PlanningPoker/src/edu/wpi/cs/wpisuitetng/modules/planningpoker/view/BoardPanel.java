...
import edu.wpi.cs.wpisuitetng.modules.planningpoker.controller.AddMessageController;
...
public class BoardPanel extends JPanel {
    ...
    /**
     * This is a model for the lstBoard component. Basically it contains the data to be displayed in
     * the list box.
     */
    private final PostBoardModel lstBoardModel;

    /**
     * Construct the panel, the three components, and add the three components to the panel.
     */
    public BoardPanel(final PostBoardModel model) {
