...
ItemListener
{
	 ...
	 * @return whether the panel can be removed. * @see edu.wpi.cs.wpisuitetng.modules.planningpoker.view.requirements.RequirementPanelListener#readyToRemove() * @see edu.wpi.cs.wpisuitetng.modules.planningpoker.view.requirements.RequirementPanelListener#readyToRemove() * @see edu.wpi.cs.wpisuitetng.modules.planningpoker.view.requirements.RequirementPanelListener#readyToRemove()
	 */
