...
import edu.wpi.cs.wpisuitetng.modules.planningpoker.view.MySessionTab.ClosedSessionTable;
 ...
 * @version Apr 8, 2014
 */
public class GetPlanningPokerSessionControllerClosed implements ActionListener {
    
    private final ClosedSessionTable model;
    
    public GetPlanningPokerSessionControllerClosed(ClosedSessionTable model)
    {
        this.model = model;
    }  
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        request.addObserver(new GetPlanningPokerSessionRequestObserverClosed(this)); // add an observer to process the response
