...
public class SessionPanel extends JPanel implements SessionButtonListener {
    ...
    private void buildLayout() {
        ...
        final Font boardFont = new Font(infoLabel.getFont().getName(), Font.BOLD, infoLabel
                        .getFont().getSize());
        ...
        final JFormattedTextField hourf = ((JSpinner.NumberEditor) hourSpin.getEditor())
                        .getTextField();
        ...
        final JFormattedTextField minf = ((JSpinner.NumberEditor) minuteSpin.getEditor())
                        .getTextField();
    ...
    public void addDecksToList(Deck[] decks) {
        ...
        System.out.println("DeckSet size = " + DeckSet.getInstance().getDecks().size());
                ...
                if (arg0.getStateChange() == ItemEvent.SELECTED) {
                    ...
                    if (selectedDeck.equals("Default") || selectedDeck.equals("-None-")) {
                        ...
                        chosenSequence.setText("  "
                                        + DeckSet.getInstance().getDecks().get(selectedDeck)
                                                        .cardsToString());
                    }
    ...
    public PlanningPokerSession createSessionFromFields() {
        ...
        final PlanningPokerSession session = new PlanningPokerSession(displaySession.getID(),
                        nameField.getText(), desField.getText(), dateChooser.getDate(),
                        Integer.parseInt(hourSpin.getValue().toString()),
                        Integer.parseInt(minuteSpin.getValue().toString()),
                        requirementsPanel.getSelectedRequirements(), type, isOpen, false,
