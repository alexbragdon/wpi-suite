 ...
 * @version Apr 8, 2014
 */
public class GetPlanningPokerSessionControllerModerating implements ActionListener {
    
    private final ModeratingSessionTable model;
    
    public GetPlanningPokerSessionControllerModerating(ModeratingSessionTable model)
    {
        this.model = model;
    }        
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        request.addObserver(new GetPlanningPokerSessionRequestObserverModerating(this)); // add an observer to process the response
